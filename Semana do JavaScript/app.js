...
const impares = randomNumbers.filter(number => number % 2 != 0)

console.log(`EX01: Os numeros impares da array randomNumbers são: ${impares.sort()} `)
console.log("######################################################")
/*
  02
...
const abaixo = crazyNumbers.filter(number => number < 501)
console.log(`EX02: A quantidade de números menores que 501 da array crazyNumbers é ${abaixo.length}`)
console.log("######################################################")
...
console.log(`EX03: Os números ao quadrado da array numbers são: ${quadrado}`)
console.log("######################################################")
/*
  04
...
const antes2000 = tarantinoMovies.filter(filme => filme.release <2000)
console.log("EX04: Os filmes que foram lançados antes do ano 2000 são:")
...
const nomes = tvShows.map(({name}) => name) // destruction 
console.log("EX05: Os nomes das séries da array tvShows são:")
console.log(nomes)
console.log("######################################################")
/*
  06
...
const productList = cart.reduce((accumulator, product) => {
  ...
  console.log("EX06: Os nomes dos jogos da array cart são: \n"+ productList)
